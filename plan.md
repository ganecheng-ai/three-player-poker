...
### v1.0.7 - Bug 修复
- [x] 修复出牌按钮点击无效问题 (main.py: 添加 Play 按钮点击处理)
- [x] 修复 button_text 字典未初始化问题 (screen.py: 在 __init__ 中初始化)
- [x] 改进中文字体加载逻辑，支持多平台字体路径 (screen.py)
- [x] 修复 issue #4: 游戏没有出牌功能，页面上很多小的白框

### v1.0.8 - AI 策略优化
- [x] 修复 AI 管牌逻辑bug (ai.py: 修复炸弹和王炸使用逻辑)
